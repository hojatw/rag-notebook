...
MESSAGES: dict[str, dict[str, str]] = {
    "zh-TW": {
        ...
        # --- E3a answer feedback ---------------------------------------------
        "feedback.prompt": "這個回答有用嗎？",
        "feedback.rating_usable": "可以直接採用",
        ...
        "feedback.reason_retrieval": "找不到我要的資料",
        "feedback.reason_generation": "找到了但答錯或不完整",
        "feedback.reason_citation": "引用跟內容對不上",
        "feedback.reason_grounding": "資料裡沒有卻硬答",
        "feedback.reason_over_abstain": "明明有資料卻說找不到",
        "feedback.reason_non_quality": "太慢或格式問題",
        "feedback.reason_other": "其他",
        "feedback.other_label": "請簡短說明",
        "feedback.other_placeholder": "例如：答案重複了三次",
        "feedback.submit_reasons": "送出補充",
        "feedback.admin_notice": "你的回饋會提供給系統管理員作為參考。",
        "feedback.invalid_rating": "評價選項無效。",
        # --- E3a admin review page -------------------------------------------
        "feedback_admin.title": "回答回饋",
        "feedback_admin.intro": "使用者對回答的評價，用來找出最常失敗的問題類型，並作為建立評測題目的來源。",
        "feedback_admin.not_a_metric": "注意：這些數字不是品質指標。每則回饋來自不同的問題、時間與使用者期待，屬於不受控的樣本；「本週負評變少」不能當作調整有效的證據。要驗證調整是否有效，請用固定題集在「評測」頁比較。",
        "feedback_admin.total": "回饋總數",
        "feedback_admin.by_rating": "依評價",
        "feedback_admin.by_reason": "依原因",
        "feedback_admin.filter_rating": "評價",
        "feedback_admin.filter_reason": "原因",
        "feedback_admin.filter_notebook": "Notebook ID",
        "feedback_admin.filter_since": "起始日期",
        "feedback_admin.filter_apply": "篩選",
        "feedback_admin.filter_clear": "清除",
        "feedback_admin.col_created": "時間",
        "feedback_admin.col_user": "使用者",
        "feedback_admin.col_notebook": "Notebook",
        "feedback_admin.col_rating": "評價",
        ...
        "feedback_admin.context_hints": "領域提示",
        "feedback_admin.context_policy": "回答規則",
        "feedback_admin.context_on": "開",
        "feedback_admin.context_off": "關",
