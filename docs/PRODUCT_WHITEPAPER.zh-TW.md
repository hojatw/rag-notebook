...
- 來源比較：整理多份來源的「共同點」、「差異」與「待釐清」事項。
  無主題時可比較 2–10 份來源摘要；指定主題時限 2–3 份，先檢索各來源再比較。
  提示詞要求不把不同專案或版本的差異直接視為矛盾，生成內容仍需人工核對；
  證據不足時明示需確認的條件，不自動判定文件效力或取代關係，也不保證涵蓋全文所有差異。
  結果附來源編號、檔名與證據狀態對照，存成筆記或匯出時一併保留；共同點需指明適用來源，
  避免將部分文件的共通內容誤認為全部文件一致。
