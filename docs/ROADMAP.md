...
- **Implementation plan:** [`O0_DIMENSION_RESET_PLAN.md`](O0_DIMENSION_RESET_PLAN.md) — phased breakdown, test matrix, and the four design decisions awaiting a ruling (concurrent-ingest handling, stale-source status, UI placement, script retirement).
