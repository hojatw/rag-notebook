...
> **已封存 2026-08-22。這是 2026-06-19/20 的走查快照，所有項目均已結案。**
> 保留它是為了追溯「某個 UI 決定當初是為了解決什麼問題」。
> 走查的**方法與準則**是 durable 規範，在 [`UX_REVIEW_GUIDE.md`](../UX_REVIEW_GUIDE.md)
> （未封存）；下一次走查請照那份產出一份新的快照，不要改寫這一份。
